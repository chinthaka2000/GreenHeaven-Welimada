  ...
  const handleSeedBlogs = async () => {
    ...
    const exampleBlogs = [
      ...
      },
      {
        ...
        excerpt: "Join our local guides as we explore the rich biodiversity surrounding GreenHaven, from endemic birds to elusive leopards in nearby reserves.",
      ...
      },
      {
        ...
        excerpt: "Find your center with guided sunrise yoga sessions overlooking the lush, terraced paddy fields of GreenHaven.",
